...
display:flex; 
justify-content:space-between;
font-weight:${(props)=> props.type === "total" && "950"};
  ...
  return (
    <Container>
        ...
        <PriceDetail>
          ...
          <ProductPrice>Ksh.400</ProductPrice>
        </PriceDetail>
...
<PriceDetail>
  ...
  <ProductPrice>Ksh.400</ProductPrice>
        ...
        <SummaryItemPrice> Ksh 800 </SummaryItemPrice>
      ...
      <SummaryItem>
        ...
        <SummaryItem type ="total">
         ...
         <SummaryItemPrice> Ksh 950 </SummaryItemPrice>
         </SummaryItem>
